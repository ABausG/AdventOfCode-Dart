...
void main() {
  group(
    ...
    () {
      ...
      test('Part 2', () {
        var day = Day08()..inputForTesting = _exampleInput2;
        expect(day.solvePart2(), _exampleSolutionPart2);

        day = Day08()..inputForTesting = _exampleInput1;
        expect(day.solvePart2(), 34);
      });
    },
  );
  group(
    ...
    () {
      ...
      test(
        ...
        skip: _puzzleSolutionPart2 == null
            ...
            : false,
        () {
          final solution = day.solvePart2();
          expect(solution, greaterThan(1114));
          expect(solution, lessThan(1123));
          expect(solution, _puzzleSolutionPart2);
        },
      );
    },
  );
